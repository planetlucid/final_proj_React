...
class SongsTest < ApplicationSystemTestCase
  ...
  test "creating a Song" do
    ...
    fill_in "Credits", with: @song.credits
    fill_in "Genre", with: @song.genre
    fill_in "Image url", with: @song.image_url
    fill_in "Key", with: @song.key
    fill_in "Mode", with: @song.mode
    fill_in "Sales", with: @song.sales
    fill_in "Streams", with: @song.streams
    fill_in "Structure", with: @song.structure
